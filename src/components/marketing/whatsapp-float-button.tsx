...
export function WhatsappFloatButton() {
  ...
  return (
    <a
      ...
      className={cn(
        "group fixed right-5 z-40 flex items-center gap-2.5 rounded-full bg-primary py-3.5 pl-3.5 pr-3.5 text-primary-foreground shadow-lg shadow-primary/30 transition-all hover:pr-5 sm:right-6",
        // Mientras el cartel de cookies ocupa la esquina inferior, este
        // botón se corre arriba del todo para no quedar tapado por él.
        cookieBannerVisible ? "bottom-44 sm:bottom-24" : "bottom-5 sm:bottom-6"
      )}
    >
